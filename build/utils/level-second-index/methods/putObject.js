...
module.exports = async function putObject(object) {
  ...
  async function indexObject(indexStore, propertyValue, objectId) {
    ...
    try {
      ...
      if (e.name === 'NotFoundError') ids = [];else if (e.message.includes("Cannot read property 'get'")) throw new Error('Index storage had to be constructed for each object key. Unprepared object key has been passed.');else throw e;
    }
