...
function recursion(original, layers, receiver) {
  ...
  receiver.event.on('emission', original.particle.process); // this.overlays.layers.recursion = this;
}
//# sourceMappingURL=name_tag:recursion.js.map